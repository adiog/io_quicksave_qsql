...
public:
    ...
    {
        return dynamic_cast<AstNode *>(new AstQsqlQuery(ctx->children[1]->accept(this)));
    }
    ...
    {
        return dynamic_cast<AstNode *>(new AstQsTagPredicate(
            ctx->children[1]->accept(this)));
    }
    ...
    {
        return dynamic_cast<AstNode *>(new AstQsGetItemName(
            ctx
        ));
    }
    ...
    {
        return dynamic_cast<AstNode *>(new AstQsGetItemText(
            ctx
        ));
    }
    ...
    {
        return dynamic_cast<AstNode *>(new AstQsGetItemType(
            ctx
        ));
    }
    ...
    {
        return dynamic_cast<AstNode *>(new AstQsGetItemAuthor(
            ctx
        ));
    }
    ...
    {
        return dynamic_cast<AstNode *>(new AstQsGetItemSourceTitle(
            ctx
        ));
    }
    ...
    {
        return dynamic_cast<AstNode *>(new AstQsGetItemSourceUrl(
            ctx
        ));
    }
